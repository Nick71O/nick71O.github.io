  ...
  async function launch() {
      try {
          ...
          if (scAvailableArrivalDate !== null && scAvailableDepartureDate !== null) {
              ...
              const isCampsiteAvailableResult = isCampsiteAvailable(preferredSiteTypes, true);
              ...
              if (bookingNumberOfNights === '1') {
                  ...
                  if (availabilityRecord) {
                      ...
                      const isCampsiteAvailableResult = isCampsiteAvailable(preferredSiteTypes, );
  ...
  function isCampsiteAvailable(preferredSiteTypes, clickButton = false) {
